export default function CountryPopup({ country, x, y, config, onExplore, onMouseEnter, onMouseLeave }) {
  ...
  const accent = config?.borderColour || '#2ab5a0';
  const W = 200, PAD = 16;
  ...
  return (
    ...
    >
      <div style={{
        ...
        {/* Header */}
        <div style={{ padding: '9px 12px 7px', display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        <button
          ...
          style={{
            ...
            borderTop: '1px solid rgba(255,255,255,0.07)', cursor: 'none',
